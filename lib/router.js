...
module.exports = (server) => {
  ...
  return async (req, res) => {
    try {
      ...
      // serve modules
      await serve_module(req, res, 'vue', true)
      await serve_module(req, res, 'vue-router', true)
      await serve_module(req, res, 'axios', true)
      await serve_module(req, res, 'vue-progressbar', 'vue-progressbar.js')
