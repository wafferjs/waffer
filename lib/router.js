...
module.exports = (server) => {
  ...
  return async (req, res) => {
    try {
      ...
      // serve modules
      if (await utils.serve_module(req, res, 'vue', true)) return
      if (await utils.serve_module(req, res, 'vue-router', true)) return
      if (await utils.serve_module(req, res, 'axios', true)) return
      if (await utils.serve_module(req, res, 'vue-progressbar', 'vue-progressbar.js')) return
