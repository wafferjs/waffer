...
module.exports = (server) => {
  ...
  return async (req, res) => {
    try {
      ...
      // serve modules
      serve_module(req, res, 'vue', true)
      serve_module(req, res, 'vue-router', true)
      serve_module(req, res, 'axios', true)
      serve_module(req, res, 'vue-progressbar', 'vue-progressbar.js')
